...
var BaseExtension = (function (_super) {
    ...
    BaseExtension.prototype.onDispose = function () {
    };
    ...
    BaseExtension.prototype._deserializeProperties = function (propertiesJson) {
        ...
        try {
            ...
            sp_telemetry_1._TraceLogger.logError(BaseExtension._logSource, new Error("Failed to deserialize properties for extension \"" + this.context.manifest.alias + "\"\n          + \" with id=" + this.context.manifest.id + ": " + e.message));
        }
    };
    return BaseExtension;
}(sp_component_base_1.BaseComponent));
BaseExtension._logSource = sp_telemetry_1._LogSource.create('BaseExtension');
__decorate([
    decorators_1.virtual
], BaseExtension.prototype, "onInit", null);
__decorate([
    decorators_1.virtual
], BaseExtension.prototype, "onDispose", null);
