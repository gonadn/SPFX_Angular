...
export default class BaseApplication {
    ...
    /**
     * RESERVED FOR INTERNAL USAGE. This method is invoked automatically by the shell to render the application.
     * The application code should not call it directly.
     *
     * @internal
     */
    _render(domElement: HTMLDivElement): void;
    /**
