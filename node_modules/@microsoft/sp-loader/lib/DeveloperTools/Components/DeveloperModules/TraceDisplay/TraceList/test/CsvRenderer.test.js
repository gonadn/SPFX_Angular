...
var LogEvent_1 = require("@ms/sp-telemetry/lib/Api/LogEvent");
var LogLevel_1 = require("@ms/sp-telemetry/lib/Api/LogLevel");
...
describe('CsvRenderer', function () {
    describe('triggerCsvDownload', function () {
        ...
        beforeEach(function () {
            ...
            simpleTestData = [new LogEvent_1.default('src', 'message', LogLevel_1.LogLevel.Error, undefined)];
        ...
        describe('the file contents', function () {
            ...
            it('formats multiple lines correctly', function () {
                var testData = [
                    new LogEvent_1.default('src1', 'message1', LogLevel_1.LogLevel.Error, undefined),
                    new LogEvent_1.default('src2', 'message2', LogLevel_1.LogLevel.Verbose, undefined)
                ];
            ...
            it('prints the "error" level correctly', function () {
                var testData = [
                    new LogEvent_1.default('src', 'message', LogLevel_1.LogLevel.Error, undefined)
                ];
                setTimestamp(testData[0]);
                CsvRenderer_1.triggerCsvDownload(testData);
                var linkElement = getElement();
            ...
            it('prints the "warning" level correctly', function () {
                var testData = [
                    new LogEvent_1.default('src', 'message', LogLevel_1.LogLevel.Warning, undefined)
                ];
                setTimestamp(testData[0]);
                CsvRenderer_1.triggerCsvDownload(testData);
                var linkElement = getElement();
            ...
            it('prints the "info" level correctly', function () {
                var testData = [
                    new LogEvent_1.default('src', 'message', LogLevel_1.LogLevel.Info, undefined)
                ];
                setTimestamp(testData[0]);
                CsvRenderer_1.triggerCsvDownload(testData);
                var linkElement = getElement();
            ...
            it('prints the "verbose" level correctly', function () {
                var testData = [
                    new LogEvent_1.default('src', 'message', LogLevel_1.LogLevel.Verbose, undefined)
                ];
                setTimestamp(testData[0]);
                CsvRenderer_1.triggerCsvDownload(testData);
                var linkElement = getElement();
            ...
            it('escapes quotes inside a field correctly', function () {
                var testData = [
                    new LogEvent_1.default('a"b', 'message', LogLevel_1.LogLevel.Error, undefined)
                ];
                setTimestamp(testData[0]);
                CsvRenderer_1.triggerCsvDownload(testData);
                var linkElement = getElement();
            ...
            it('escapes newlines inside a field correctly', function () {
                var testData = [
                    new LogEvent_1.default('a\nb', 'message', LogLevel_1.LogLevel.Error, undefined)
                ];
                setTimestamp(testData[0]);
                CsvRenderer_1.triggerCsvDownload(testData);
                var linkElement = getElement();
