    ...
    DebugPrompt.prototype.render = function () {
        ...
        return !this.state.dismissed
            ? (React.createElement("div", { role: 'dialog', "data-automation-id": 'debugManifestPromptDialog', "aria-labelledby": 'manifestWarningLabel' },
                React.createElement(Dialog_1.Dialog, { isOpen: this.state.showDialog, type: Dialog_1.DialogType.largeHeader, title: DebugPrompt_resx_1.default.debugManifestLoadingTitle, isBlocking: true, containerClassName: debugComponents_module_scss_1.default.dialogContainer },
