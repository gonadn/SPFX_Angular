define([], function() {
  var strings = {
    ...
    "_fwMQe6Xe08yEeCPNxngd+g": {
      "warningHeading": "警告!",
      "warningLine1": "使用此工具會使您暴露在潛在安全性威脅之中，這可能會導致其他人獲得您個人 Office 365 資料 (文件、電子郵件、交談等等) 的存取權。請先確定您信任要求您使用此工具的人員或組織，然後再繼續。",
      "warningLine2": "在此深入了解: {0}"
    },
