define([], function() {
  var strings = {
    ...
    "_upo3vfLFBbnbzl2hKy2TwA": {
      "debugManifestLoadingTitle": "Разрешаване на манифестите за отстраняване на грешки?",
      ...
      "debugManifestLoadingCalloutText": "Ако не знаете какво е това, щракнете тук."
    },
