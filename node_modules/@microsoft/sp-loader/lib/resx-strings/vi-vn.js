define([], function() {
  var strings = {
    ...
    "_fwMQe6Xe08yEeCPNxngd+g": {
      ...
      "warningLine1": "Việc sử dụng công cụ này sẽ khiến bạn đối mặt với mối đe dọa bảo mật tiềm tàng, có thể dẫn đến việc những người khác có quyền truy nhập vào dữ liệu Office 365 cá nhân của bạn (tài liệu, email, cuộc hội thoại và các nội dung khác). Hãy đảm bảo rằng bạn tin tưởng người hoặc tổ chức yêu cầu bạn truy nhập công cụ này trước khi tiếp tục.",
    ...
    "_upo3vfLFBbnbzl2hKy2TwA": {
      "debugManifestLoadingTitle": "Bạn muốn cho phép Gỡ lỗi cho Tệp kê khai?",
      ...
      "debugManifestLoadingCalloutText": "Nếu bạn không biết điều này là gì, hãy bấm vào đây."
    },
