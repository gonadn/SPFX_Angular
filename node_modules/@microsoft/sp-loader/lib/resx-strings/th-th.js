define([], function() {
  var strings = {
    ...
    "_nQNACBeQ34aV6bVwtFBayA": {
      ...
      "urlStatusLocalhostNetworkErrorError": "ล้มเหลวในการโหลด URL '{3}' สำหรับทรัพยากร '{2}' ในคอมโพเนนต์ '{0}' ({1}) มีปัญหาเครือข่าย\r\nตรวจสอบให้แน่ใจว่า คุณได้รัน 'gulp ใบรับรองความน่าเชื่อถือสูง'",
    ...
    "_upo3vfLFBbnbzl2hKy2TwA": {
      "debugManifestLoadingTitle": "อนุญาตให้มีการดีบักไฟล์การตรวจสอบหรือไม่",
      ...
      "debugManifestLoadingCalloutText": "ถ้าคุณไม่ทราบว่านี่คืออะไร คลิกที่นี่"
    },
