define([], function() {
  var strings = {
    ...
    "_nQNACBeQ34aV6bVwtFBayA": {
      ...
      "urlStatusLocalhostNetworkErrorError": "Laden van URL {3} voor resource {2} in onderdeel {0} ({1}) is mislukt. Er doet zich een probleem voor met het netwerk.\r\nControleer of gulp trust-dev-cert wordt uitgevoerd.",
    ...
    "_upo3vfLFBbnbzl2hKy2TwA": {
      "debugManifestLoadingTitle": "Manifesten voor foutopsporing toestaan?",
      ...
      "debugManifestLoadingCalloutText": "Klik hier als u niet weet wat dit is."
    },
