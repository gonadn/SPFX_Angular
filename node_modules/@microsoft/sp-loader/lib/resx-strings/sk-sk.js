define([], function() {
  var strings = {
    ...
    "_nQNACBeQ34aV6bVwtFBayA": {
      ...
      "urlStatusLocalhostNetworkErrorError": "Nepodarilo sa načítať URL adresu {3} pre prostriedok {2} v súčasti {0} ({1}). Vyskytol sa problém so sieťou.\r\nSkontrolujte, či máte spustený príkaz gulp trust-dev-cert.",
    ...
    "_upo3vfLFBbnbzl2hKy2TwA": {
      "debugManifestLoadingTitle": "Povoliť manifesty ladenia?",
      ...
      "debugManifestLoadingCalloutText": "Ak neviete, čo to je, kliknite sem."
    },
