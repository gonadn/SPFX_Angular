define([], function() {
  var strings = {
    ...
    "_nQNACBeQ34aV6bVwtFBayA": {
      ...
      "urlStatusLocalhostNetworkErrorError": "\"{0}\" ({1}) компонентіндегі \"{2}\" ресурсына арналған \"{3}\" URL мекенжайы мекенжайын жүктеу сәтсіз аяқталды. Желі ақаулығы пайда болды.\r\n\"Gulp trust-dev-cert\" іске қосылғанын тексеріңіз.",
    ...
    "_upo3vfLFBbnbzl2hKy2TwA": {
      "debugManifestLoadingTitle": "Қателерді түзету манифестеріне рұқсат ету қажет пе?",
      ...
      "debugManifestLoadingCalloutText": "Егер бұның не екенін білмесеңіз, осы жерді басыңыз."
    },
