define([], function() {
  var strings = {
    ...
    "_nQNACBeQ34aV6bVwtFBayA": {
      ...
      "urlStatusLocalhostNetworkErrorError": "No s'ha pogut carregar l'URL \"{3}\" del recurs \"{2}\" al component \"{0}\" ({1}). S'ha produït un problema de xarxa.\r\nAssegureu-vos que heu executat \"gulp trust-dev-cert\".",
    ...
    "_upo3vfLFBbnbzl2hKy2TwA": {
      "debugManifestLoadingTitle": "Voleu permetre manifests de depuració?",
      "debugManifestLoadingWarning": "ADVERTIMENT: aquesta pàgina està sol·licitant carregar scripts no segurs que podrien malmetre l'ordinador. No continueu tret que confieu en el desenvolupador i n'entengueu els riscos.",
      ...
      "debugManifestLoadingCalloutText": "Si no sabeu què és això, feu clic aquí."
    },
