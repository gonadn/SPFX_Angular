define([], function() {
  var strings = {
    ...
    "_nQNACBeQ34aV6bVwtFBayA": {
      ...
      "urlStatusLocalhostNetworkErrorError": "دربارگذاری URL '{3}' برای منبع '{2}' در جز '{0}' ({1}) ناکام ماند. یک مشکل در شبکه وجود داشت.\r\nمطمئن شوید که شما 'gulp trust-dev-cert' را اجرا کرده اید.",
    ...
    "_upo3vfLFBbnbzl2hKy2TwA": {
      "debugManifestLoadingTitle": "اجازه دادن اظهارنامه های عیب زدایی؟",
      ...
      "debugManifestLoadingCalloutText": "اگر شما این را نمی شناسید، اینجا کلیک کنید."
    },
