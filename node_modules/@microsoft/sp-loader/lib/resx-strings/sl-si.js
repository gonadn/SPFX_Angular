define([], function() {
  var strings = {
    "_gIErrcTokcw+/VVwa+ReIA": {
      "invalidEnvironmentTypeError": "Vrsta EnvironmentType ni veljavna",
    ...
    "_nQNACBeQ34aV6bVwtFBayA": {
      ...
      "urlStatusLocalhostNetworkErrorError": "Ni mogoče naložiti URL-ja »{3}« za vir »{2}« v komponenti »{0}« ({1}). Prišlo je do težave z omrežjem.\r\nPreverite, ali se izvaja »gulp trust-dev-cert«.",
    ...
    "_upo3vfLFBbnbzl2hKy2TwA": {
      "debugManifestLoadingTitle": "Ali želite dovoliti iskanje napak v manifestu?",
      ...
      "debugManifestLoadingCalloutText": "Če ne veste, kaj to je, kliknite tukaj."
    },
