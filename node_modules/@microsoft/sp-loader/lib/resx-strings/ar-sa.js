define([], function() {
  var strings = {
    ...
    "_nQNACBeQ34aV6bVwtFBayA": {
      ...
      "urlStatusLocalhostNetworkErrorError": "فشل تحميل URL '{3}' للمورد '{2}' في المكون '{0}' ({1}). هناك مشكلة في الشبكة.\r\nتأكد من أن تقوم بتشغيل 'gulp trust-dev-cert'.",
    ...
    "_upo3vfLFBbnbzl2hKy2TwA": {
      "debugManifestLoadingTitle": "هل تريد السماح ببيانات تتبع الأخطاء؟",
