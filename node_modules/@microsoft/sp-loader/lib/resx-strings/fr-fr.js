define([], function() {
  var strings = {
    ...
    "_nQNACBeQ34aV6bVwtFBayA": {
      ...
      "urlStatusLocalhostNetworkErrorError": "Le chargement de l’URL « {3} » associée à la ressource « {2} » dans le composant « {0} » a échoué ({1}). Nous n’avons pas trouvé le fichier sur le serveur.\r\nAssurez-vous d’exécuter la commande « gulp trust-dev-cert ».",
    ...
    "_upo3vfLFBbnbzl2hKy2TwA": {
      "debugManifestLoadingTitle": "Voulez-vous autoriser le débogage des manifestes ?",
      ...
      "debugManifestLoadingCalloutText": "Si vous ne savez pas de quoi il s’agit, cliquez ici."
    },
