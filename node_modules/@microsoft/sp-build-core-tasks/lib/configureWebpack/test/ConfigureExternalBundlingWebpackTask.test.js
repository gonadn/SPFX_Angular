...
describe('ConfigureExternalBundlingWebpackTask', function () {
    ...
    describe('executeTask', function () {
        ...
        it('has a valid Configuration', function () {
            ...
            configs.forEach(function (config) {
                ...
                chai_1.assert.equal(module.noParse.length, 1);
                chai_1.assert.isNotNull('test.map'.match(module.noParse[0]));
                chai_1.assert.isNull('test.mape'.match(module.noParse[0]));
                // No source-map-loader in non-production mode
                chai_1.assert.equal(module.rules.length, 1);
                chai_1.assert.match(module.rules[0].use, /source\-map\-loader/);
    ...
    describe('tinkerWithBaseWebpackConfig', function () {
