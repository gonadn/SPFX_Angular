...
var CopyAssetsTask = (function (_super) {
    ...
    CopyAssetsTask.prototype.executeTask = function (gulp, completeCallback) {
        ...
        if (!webpackStats) {
            if (this.properties.entries && this.properties.entries.length > 0) {
        ...
        bundleEntries.forEach(function (bundleEntry) {
            ...
            // If the manifest version is "*", replace it with the package version. This also happens in
            //  ConfigureWebpackTask. Here is just for a sanity check.
            if (manifest.version === '*') {
        ...
        stringsCopyCallbackMap.forEach(function (callbacks, key) {
            ...
            var _loop_2 = function (locale) {
                if (localizedFiles.hasOwnProperty(locale)) {
                    tasks.push(_this._renameWithHash(gulp.src(localizedFiles[locale]), function (hash) { return _this.taskConfig.excludeHashFromFileNames ?
                        baseFilename + "_" + locale + ".js" :
                        baseFilename + "_" + locale + "_" + hash + ".js"; }, function (filename) {
    ...
    CopyAssetsTask.prototype._processEntry = function (deployEntry, shouldPrepareProductionDeployment, stringsModuleId, bundleTemporaryNameRegex, tasks) {
        ...
        if (bundleEntry.nonLocalizedEntrypointPath) {
            ...
            if (shouldPrepareProductionDeployment) {
                ...
                getFilenameCallback = function (hash) { return _this.taskConfig.excludeHashFromFileNames ?
                    entryName.toLowerCase() + ".js" :
                    entryName.toLowerCase() + "_" + hash + ".js"; };
            }
        }
            ...
            if (shouldPrepareProductionDeployment) {
                ...
                getFilenameCallback = function (hash, originalFilename) {
                    var locale = reverseEntrypointLookup_1[originalFilename];
                    return _this.taskConfig.excludeHashFromFileNames ?
                        entryName.toLowerCase() + "_" + locale + ".js" :
                        entryName.toLowerCase() + "_" + locale + "_" + hash + ".js";
                };
            }
        }
        else {
    ...
    CopyAssetsTask.prototype._processExternals = function (externalModules, tasks) {
        ...
        externalModules.forEach(function (externalModule) {
            if (externalModule.renameCallbacks.length > 0) {
                ...
                tasks.push(_this._renameWithHash(gulp.src(externalModule.configExternalFullPath), function (hash) { return _this.taskConfig.excludeHashFromFileNames ?
                    baseFilename_1.toLowerCase() + ".js" :
                    baseFilename_1.toLowerCase() + "_" + hash + ".js"; }, function (filename) {
