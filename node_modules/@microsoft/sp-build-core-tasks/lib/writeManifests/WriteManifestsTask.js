...
var WriteManifestsTask = (function (_super) {
    ...
    WriteManifestsTask.prototype.executeTask = function (gulp, completeCallback) {
        ...
        this.taskConfig.debugLocale = this.normalizeLocaleName(this.taskConfig.debugLocale);
        ...
        this.properties.deployEntries.forEach(function (deployEntry) {
            ...
            if (shouldProduceDebugManifests) {
                deployEntry.manifest = _this._getLocalizedManifest(deployEntry.manifest, _this.taskConfig.debugLocale);
            ...
            if (shouldProduceProductionManifests) {
                deployEntry.manifest = _this._getLocalizedManifest(deployEntry.manifest);
