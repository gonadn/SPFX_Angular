...
export declare class WriteManifestsTask extends OdspGulpTask<IWriteManifestsTaskConfig> {
     ...
     */
    private _getLocalizedManifest(manifest, defaultLocale?);
    /**
     ...
     */
    private _localizeWebPartManifest(manifest, defaultLocale?);
    /**
     * Localizes an Application manifest. This includes title and description of the Application
     */
    private _localizeApplicationManifest(manifest, defaultLocale?);
    /**
     ...
     */
    private _localizeString(stringToLocalize, defaultLocale?);
    /**
