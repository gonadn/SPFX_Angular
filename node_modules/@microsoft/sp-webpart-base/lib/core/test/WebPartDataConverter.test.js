...
var wpdataEncoded = "{&quot;id&quot;:&quot;cef86cc2-e8eb-4222-ac05-26b14ca6aa2c&quot;,&quot;instanceId&quot;:&quot;2e895656-4fda-43d0-ad98-2a979daf5f41&quot;,&quot;title&quot;:&quot;test webpart data&quot;,&quot;description&quot;:&quot;this data is used to test web part data converter utility&quot;,&quot;dataVersion&quot;:&quot;1.0&quot;,&quot;properties&quot;:{&quot;phone&quot;:&quot;(101) 101-1010&quot;,&quot;website&quot;:{&quot;name&quot;:&quot;Doe's Blog&quot;}}}";
var encodedName = '&lt;John Doe&gt;';
var htmlPropsString = "<div data-sp-prop-name=\"bio\">" + wpdata.serverProcessedContent.htmlStrings['bio'] + "</div>" +
    ...
    ("<div data-sp-prop-name=\"name\" data-sp-searchableplaintext=\"true\">" + encodedName + "</div>") +
    ("<a data-sp-prop-name=\"website.url\" href=\"" + wpdata.serverProcessedContent.links['website.url'] + "\"></a>");
var htmlPropsStringWithSPLink = htmlPropsString +
    ("<a data-sp-prop-name=\"website.url\" data-sp-splink=\"__SPLINK__0__\" href=\"" + wpdata.serverProcessedContent.links['website.url'] + "\"></a>");
...
describe('WebPartDataConverter tests', function () {
    ...
    it('converts html to server-processed data with external links', function () {
        var serverPrcoessedDataWithLinks = lodash.cloneDeep(wpdata.serverProcessedContent);
        if (serverPrcoessedDataWithLinks && serverPrcoessedDataWithLinks.links) {
            serverPrcoessedDataWithLinks.links['website.url'] = 'http://myLink0';
        }
        assertEqualJsons(WebPartDataConverter_1.default.convertServerProcessedHtmlToData(htmlPropsStringWithSPLink, links), serverPrcoessedDataWithLinks);
    });
