...
var MockWebPartManifest = (function () {
    function MockWebPartManifest() {
        ...
        this.loaderConfig = test_1.TEST_UNDEFINED;
    }
...
var MockWebPartManagerContext = (function () {
    function MockWebPartManagerContext() {
        ...
        this.webPartData = test_1.TEST_UNDEFINED;
        this.displayMode = sp_core_library_1.DisplayMode.Read;
        this.host = test_1.TEST_UNDEFINED;
    }
...
var MockWebPartHost = (function () {
    function MockWebPartHost() {
        this.pageContext = new sp_page_context_1.PageContext(test_1.TEST_UNDEFINED);
        this.httpClient = test_1.TEST_UNDEFINED;
        this.spHttpClient = test_1.TEST_UNDEFINED;
        this.eventAggregator = EventAggregator_1.default;
        this.statusRenderer = new MockClientSideWebPartStatusRenderer();
        this.serviceScope = test_1.TEST_UNDEFINED;
