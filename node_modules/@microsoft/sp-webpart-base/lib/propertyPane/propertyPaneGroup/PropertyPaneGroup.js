    ...
    PropertyPaneGroup.prototype._renderGroupField = function (groupField) {
        ...
        switch (groupField.type) {
            ...
            case IPropertyPaneField_1.PropertyPaneFieldType.Toggle:
                groupFieldElement =
                    React.createElement(office_ui_fabric_react_1.Toggle, __assign({}, groupField.properties, { componentRef: setRef, checked: propValue, onText: groupField.properties.onText || Strings_resx_1.default.ToggleOnText, offText: groupField.properties.offText || Strings_resx_1.default.ToggleOffText, onChanged: function (value) {
                            _this._onChange(groupField, value);
                        } }));
                break;
            case IPropertyPaneField_1.PropertyPaneFieldType.TextField:
                groupFieldElement = React.createElement(office_ui_fabric_react_1.TextField, __assign({}, groupField.properties, { componentRef: setRef, value: propValue ? propValue : groupField.properties.value, onChanged: function (value) {
            ...
            case IPropertyPaneField_1.PropertyPaneFieldType.Dropdown:
                groupFieldElement = React.createElement(office_ui_fabric_react_1.Dropdown, __assign({}, groupField.properties, { componentRef: setRef, selectedKey: propValue || groupField.properties.selectedKey, disabled: groupField.properties.isDisabled || groupField.properties.disabled, label: groupField.properties.label, onChanged: function (option, index) {
                        _this._onDropDownChange(groupField, option, index);
                    } }));
                break;
            case IPropertyPaneField_1.PropertyPaneFieldType.CheckBox:
                groupFieldElement = React.createElement(office_ui_fabric_react_1.Checkbox, __assign({}, groupField.properties, { componentRef: setRef, label: groupField.properties.text, checked: propValue, disabled: this._isDisabled(groupField), onChange: function (ev, isChecked) {
            ...
            case IPropertyPaneField_1.PropertyPaneFieldType.Slider:
                groupFieldElement =
                    React.createElement(office_ui_fabric_react_1.Slider, __assign({}, groupField.properties, { componentRef: setRef, value: propValue, onChange: function (value) {
                            _this._onChange(groupField, value);
                        } }));
                break;
            case IPropertyPaneField_1.PropertyPaneFieldType.ChoiceGroup:
                ...
                groupFieldElement =
                    React.createElement(office_ui_fabric_react_1.ChoiceGroup, __assign({}, groupField.properties, { componentRef: setRef, options: groupField.properties.options, className: PropertyPaneGroup_module_scss_1.default.propertyPaneChoiceGroup, onChanged: function (checkedOption) {
