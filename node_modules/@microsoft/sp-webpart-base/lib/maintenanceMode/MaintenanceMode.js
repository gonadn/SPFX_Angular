...
var MaintenanceMode = (function (_super) {
            ...
            React.createElement("div", { className: MaintenanceMode_module_scss_1.default.cardContainer },
                ...
                React.createElement("div", { className: MaintenanceMode_module_scss_1.default.cardBody },
                    React.createElement(office_ui_fabric_react_2.Pivot, null,
                        React.createElement(office_ui_fabric_react_2.PivotItem, { linkText: 'General' },
                            React.createElement("div", { className: MaintenanceMode_module_scss_1.default.pivotItem },
                                React.createElement("pre", null,
                                    React.createElement("code", null,
                                        React.createElement(MaintenanceModeText_1.MaintenanceModeText, { label: 'Alias', value: context.manifest.alias }),
                                        React.createElement(MaintenanceModeText_1.MaintenanceModeText, { label: 'Id', value: context.manifest.id }),
                                        React.createElement(MaintenanceModeText_1.MaintenanceModeText, { label: 'InstanceId', value: context.instanceId }),
                                        React.createElement(MaintenanceModeText_1.MaintenanceModeText, { label: 'IsInternal', value: isInternal.toString() }),
                                        React.createElement(MaintenanceModeText_1.MaintenanceModeText, { label: 'Version', value: context.manifest.version }),
                                        React.createElement(MaintenanceModeText_1.MaintenanceModeText, { label: 'Enviromnent', value: sp_core_library_1.Environment.type.toString() }),
                                        React.createElement(MaintenanceModeText_1.MaintenanceModeText, { label: 'UserAgent', value: navigator.userAgent }))))),
                        React.createElement(office_ui_fabric_react_2.PivotItem, { linkText: 'Manifest' },
                            React.createElement("div", { className: MaintenanceMode_module_scss_1.default.pivotItem },
                                React.createElement("pre", null,
                                    React.createElement("code", null,
                                        React.createElement("span", null, JSON.stringify(context.manifest, undefined, 2)))))),
                        React.createElement(office_ui_fabric_react_2.PivotItem, { linkText: 'Data', className: MaintenanceMode_module_scss_1.default.pivotItem },
                            React.createElement("div", { className: MaintenanceMode_module_scss_1.default.pivotItem },
                                React.createElement("pre", null,
                                    React.createElement("code", null,
    ...
    MaintenanceMode.prototype._copyData = function () {
        var details = {}; 
        var context = this.props.context;
        details.instanceId = context.instanceId;
        details.environment = sp_core_library_1.Environment.type.toString();
