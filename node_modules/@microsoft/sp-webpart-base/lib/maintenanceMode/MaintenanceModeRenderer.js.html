...
<html lang="en">
<head>
    <title>Code coverage report for z:\sp-client\1\spfx-core\sp-webpart-base\lib\maintenanceMode\MaintenanceModeRenderer.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../../../../index.html">all files</a> / <a href="index.html">z:/sp-client/1/spfx-core/sp-webpart-base/lib/maintenanceMode/</a> MaintenanceModeRenderer.js
    </h1>
    <div class='clearfix'>
...
<span class="fstat-no" title="function not covered" >    function MaintenanceModeRenderer() {</span>
    }
    MaintenanceModeRenderer.render = <span class="fstat-no" title="function not covered" >function (context, data, onRenderComplete) {</span>
<span class="cstat-no" title="statement not covered" >        require.ensure(['./MaintenanceMode'], <span class="fstat-no" title="function not covered" >function (require) {</span></span>
<span class="cstat-no" title="statement not covered" >            var maintenanceMode = require('./MaintenanceMode');</span>
<span class="cstat-no" title="statement not covered" >            var el = React.createElement(maintenanceMode.default, { context: context, data: data });</span>
<span class="cstat-no" title="statement not covered" >            ReactDOM.render(el, context.domElement);</span>
<span class="cstat-no" title="statement not covered" >            onRenderComplete();</span>
        }, 'sp-webpart-base-maintenancemode');
    };
