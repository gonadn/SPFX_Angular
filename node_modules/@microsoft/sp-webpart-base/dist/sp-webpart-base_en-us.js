define("974a7777-0990-4136-8fa6-95d80114c2e0_1.1.1", ["@microsoft/decorators","@microsoft/sp-component-base","@microsoft/sp-core-library","@microsoft/sp-http","@microsoft/sp-loader","@microsoft/sp-lodash-subset","@microsoft/sp-page-context","@ms/sp-telemetry","office-ui-fabric-react","react","react-dom"], function(__WEBPACK_EXTERNAL_MODULE_0__, __WEBPACK_EXTERNAL_MODULE_1__, __WEBPACK_EXTERNAL_MODULE_2__, __WEBPACK_EXTERNAL_MODULE_3__, __WEBPACK_EXTERNAL_MODULE_4__, __WEBPACK_EXTERNAL_MODULE_5__, __WEBPACK_EXTERNAL_MODULE_6__, __WEBPACK_EXTERNAL_MODULE_7__, __WEBPACK_EXTERNAL_MODULE_8__, __WEBPACK_EXTERNAL_MODULE_9__, __WEBPACK_EXTERNAL_MODULE_10__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(2),__webpack_require__(0),__webpack_require__(9),__webpack_require__(7),__webpack_require__(5),__webpack_require__(8),__webpack_require__(10),__webpack_require__(11),__webpack_require__(3),__webpack_require__(6),__webpack_require__(1),__webpack_require__(4)], __WEBPACK_AMD_DEFINE_RESULT__ = function(__WEBPACK_EXTERNAL_MODULE_0__, __WEBPACK_EXTERNAL_MODULE_2__, __WEBPACK_EXTERNAL_MODULE_3__, __WEBPACK_EXTERNAL_MODULE_4__, __WEBPACK_EXTERNAL_MODULE_7__, __WEBPACK_EXTERNAL_MODULE_8__, __WEBPACK_EXTERNAL_MODULE_9__, __WEBPACK_EXTERNAL_MODULE_21__, __WEBPACK_EXTERNAL_MODULE_22__, __WEBPACK_EXTERNAL_MODULE_23__, __WEBPACK_EXTERNAL_MODULE_47__, __WEBPACK_EXTERNAL_MODULE_48__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// install a JSONP callback for chunk loading
/******/ 	var parentJsonpFunction = window["webpackJsonp974a7777_0990_4136_8fa6_95d80114c2e0_1_1_1"];
/******/ 	window["webpackJsonp974a7777_0990_4136_8fa6_95d80114c2e0_1_1_1"] = function webpackJsonpCallback(chunkIds, moreModules, executeModules) {
...
/******/ 		}
/******/ 		script.src = __webpack_require__.p + "" + chunkId + "." + ({"0":"sp-webpart-base-propertypane","1":"sp-webpart-base-maintenancemode"}[chunkId]||chunkId) + "_" + {"0":"594b23b45a3759314e74","1":"311f73bfa07c327defd2"}[chunkId] + ".js";
...
var Object_1 = __webpack_require__(64);
var ExecuteAndReThrow_1 = __webpack_require__(62);
var ClassicPageUtils_1 = __webpack_require__(10);
...
var BaseClientSideWebPart = (function () {
    function BaseClientSideWebPart() {
        ...
        this._internalIsInViewport = false;
...
Object.defineProperty(exports, "__esModule", { value: true });
var lodash = __webpack_require__(7);
var sp_loader_1 = __webpack_require__(48);
var sp_http_1 = __webpack_require__(22);
var sp_telemetry_1 = __webpack_require__(4);
var sp_core_library_1 = __webpack_require__(0);
var sp_page_context_1 = __webpack_require__(23);
var BaseClientSideWebPart_1 = __webpack_require__(11);
var ClientSideWebPartStatusRenderer_1 = __webpack_require__(54);
var EventAggregator_1 = __webpack_require__(18);
var ExecuteWithoutFailing_1 = __webpack_require__(63);
var SPWebPartError_1 = __webpack_require__(15);
var PropertyPaneDefinitions_1 = __webpack_require__(5);
var PropertyPaneController_1 = __webpack_require__(60);
var WebPartContext_1 = __webpack_require__(57);
var ClassicPageUtils_1 = __webpack_require__(10);
var ViewportLoader_1 = __webpack_require__(25);
var Strings_resx_1 = __webpack_require__(6);
var WEBPARTLOADINVIEWPORTFLIGHT = 33;
...
var ClientSideWebPartManager = (function () {
        ...
        this._executeForIdsOrAll(instanceIds, function (wp, id) {
            if (!previewImageUrl) {
                ...
                if (webParthThumbnail) {
                    previewFromAlias = wp._context.manifest.alias;
    ...
    ClientSideWebPartManager.prototype._deleteWebPart = function (id) {
        ...
        if (this._instanceOfBase(wpi)) {
            sp_telemetry_1._TraceLogger.logVerboseData({
                source: this._logSource,
                message: sp_core_library_1.Text.format(Strings_resx_1.default.WebpartDeleteRequested, wpi._context.webPartTag),
        ...
        this._webparts.forEach(function (wpi) {
            if (_this._instanceOfBase(wpi) && ViewportLoader_1.default.isInIntialViewport(wpi)) {
                ...
                if (isAllInViewportRendered) {
                    var curEndTime = sp_telemetry_1._PerformanceLogger.getComponentEndTime(wpi._context.webPartTag);
...
var styles = {
    errorBox: 'errorBox_51919355',
    errorBoxText: 'errorBoxText_51919355',
    detailsButton: 'detailsButton_51919355',
    somethingWentWrongText: 'somethingWentWrongText_51919355',
    siteAdminText: 'siteAdminText_51919355',
    screenReaderOnly: 'screenReaderOnly_51919355',
};
...
var decorators_1 = __webpack_require__(2);
var sp_core_library_1 = __webpack_require__(0);
var ReservedEventNames_1 = __webpack_require__(19);
...
var ViewportLoader = (function () {
    ...
    ViewportLoader.isInIntialViewport = function (webpart) {
        ...
        var euplViewportOffset = Math.floor(viewportHeight * 0.01);
...
var decorators_1 = __webpack_require__(2);
var sp_core_library_1 = __webpack_require__(0);
var ClientSideWebPartMaintenanceModeManager_1 = __webpack_require__(53);
var ClientSideWebPartManager_1 = __webpack_require__(12);
...
// module
exports.push([module.i, ".errorBox_51919355{padding:12px 0;overflow:hidden;position:relative;top:0;left:0;right:0;z-index:1;display:inline-block}[dir=ltr] .errorBox_51919355{text-align:left}[dir=rtl] .errorBox_51919355{text-align:right}.errorBoxText_51919355{position:relative;display:inline-block;white-space:pre-wrap;color:#666;font-weight:700}.detailsButton_51919355{text-transform:uppercase;color:#0078d7;border:none;background:0 0;margin-top:20px}[dir=ltr] .detailsButton_51919355{padding-left:0}[dir=rtl] .detailsButton_51919355{padding-right:0}.somethingWentWrongText_51919355{font-weight:400;color:#0078d7}.siteAdminText_51919355{font-weight:700;color:#0078d7}.screenReaderOnly_51919355{position:absolute;text-indent:-9999px;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;border:0}", ""]);
...
// module
exports.push([module.i, "[id^=spPropertyPaneContainer].showPane_975bd0ab{width:340px}[id^=spPropertyPaneContainer].showPane_975bd0ab button{display:block}[id^=spPropertyPaneContainerNoFlexbox].spPropertyPaneContainer_975bd0ab{position:absolute;top:50px;bottom:0;z-index:999}html[dir=ltr] [id^=spPropertyPaneContainerNoFlexbox].spPropertyPaneContainer_975bd0ab{right:-340px}html[dir=rtl] [id^=spPropertyPaneContainerNoFlexbox].spPropertyPaneContainer_975bd0ab{left:-340px}html[dir=ltr] [id^=spPropertyPaneContainerNoFlexbox].showPane_975bd0ab{right:0}html[dir=rtl] [id^=spPropertyPaneContainerNoFlexbox].showPane_975bd0ab{left:0}html[dir=ltr] [id^=spPageChromeAppDiv].shrinkContent_975bd0ab{right:340px}html[dir=rtl] [id^=spPageChromeAppDiv].shrinkContent_975bd0ab{left:340px}html[dir=ltr] [id^=workbenchPageContent].shrinkContent_975bd0ab{right:340px}html[dir=rtl] [id^=workbenchPageContent].shrinkContent_975bd0ab{left:340px}html[dir=ltr] [id^=workbenchCommandBar].shrinkContent_975bd0ab{padding-right:340px}html[dir=rtl] [id^=workbenchCommandBar].shrinkContent_975bd0ab{padding-left:340px}", ""]);
...
var ClassicPageUtils_1 = __webpack_require__(10);
var ClientSideWebPartManager_1 = __webpack_require__(12);
var MaintenanceModeRenderer_1 = __webpack_require__(59);
var ClientSideWebPartMaintenanceModeManager = (function (_super) {
    ...
    ClientSideWebPartMaintenanceModeManager.prototype._loadWebPartInMaintenanceMode = function (context) {
        MaintenanceModeRenderer_1.default.render(this._getWebPartContext(context), context.webPartData, function () {
...
var sp_telemetry_1 = __webpack_require__(4);
var sp_core_library_1 = __webpack_require__(0);
var PlaceholderSpinner_1 = __webpack_require__(17);
var Strings_resx_1 = __webpack_require__(6);
var ErrorMessage_1 = __webpack_require__(24);
var FriendlyErrorMessage_1 = __webpack_require__(55);
var ClassicPageUtils_1 = __webpack_require__(10);
...
var PropertyPaneDefinitions_1 = __webpack_require__(5);
var PropertyPaneAccessor_1 = __webpack_require__(58);
var WebPartContext = (function (_super) {
    ...
    WebPartContext.prototype.onProvideServices = function (parameters) {
        ...
        if (true) {
            this._graphHttpClient = this.serviceScope.createDefaultAndProvide(sp_http_1.GraphHttpClient.serviceKey);
        }
        this._logSource = sp_telemetry_1._LogSource.create(parameters.webPartTag);
        this.serviceScope.provide(sp_telemetry_1._logSourceServiceKey, this._logSource);
    };
...
var MaintenanceModeRenderer = (function () {
    ...
    MaintenanceModeRenderer.render = function (context, data, onRenderComplete) {
        __webpack_require__.e/* require.ensure */(1).then((function (require) {
            var maintenanceMode = __webpack_require__(43);
...
var sp_telemetry_1 = __webpack_require__(4);
var PropertyPaneDefinitions_1 = __webpack_require__(5);
var Strings_resx_1 = __webpack_require__(20);
var PropertyPaneController_module_scss_1 = __webpack_require__(61);
...
var PropertyPaneController = (function () {
    ...
    PropertyPaneController.prototype._loadPropertyPaneComponent = function (shouldRecreatePropertyPaneElement) {
        ...
        __webpack_require__.e/* require.ensure */(0).then((function (require) {
            var propertyPane = __webpack_require__(67)['default'];
...
var styles = {
    showPane: 'showPane_975bd0ab',
    spPropertyPaneContainer: 'spPropertyPaneContainer_975bd0ab',
    shrinkContent: 'shrinkContent_975bd0ab',
};
exports.default = styles;
...
var WebPartForm_1 = __webpack_require__(26);
