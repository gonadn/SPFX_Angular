...
var SPWebBuildRig = (function (_super) {
    ...
    SPWebBuildRig.prototype.finalizeSharedConfig = function () {
        ...
        spBuildCoreTasks.writeManifests.mergeConfig({
            ...
            debugBasePath: (gulp_core_build_serve_1.serve.taskConfig.https ? 'https' : 'http') + "://" + gulp_core_build_serve_1.serve.taskConfig.hostname + ":" + gulp_core_build_serve_1.serve.taskConfig.port + "/"
        });
        if (this.args.production) {
